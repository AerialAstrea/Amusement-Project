...
public class attraction {
    ...
    protected double runningCost; // for one rider
    protected double rideLength; // in terms of hours
    protected int minHeight; // in inches
    protected double addOpCost; //any additional operating cost (such as maintenance)
    ...
    public attraction(int m, double t, double rC, double rL, int minH){//maxRider, ticketPrice, runCost, rideLen, minH
        maxRiders = m;
        ticketPrice = t;
        runningCost = rC;
        rideLength = rL;
    ...
    public void addAdditionalCost(double num){
        addOpCost += num;
    }

    public double totalProft(){
        return totalRiders*ticketPrice - totalRides*runningCost - addOpCost;
    }
