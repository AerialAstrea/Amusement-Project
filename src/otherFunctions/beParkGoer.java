...
public class beParkGoer {
    public static void main(){
        ...
        String [] btn_options = {"See Attraction List", "Purchase a Ticket", "Leave"};
        String [] btn_options2 = {"See Attraction List", "Check Ticket", "Leave"};
        ...
        while(!leave){
            ...
            if(result == 0){//user selected see attraction list
            ...
            else if(result == 1){//user selected purchase/check a ticket
